# flow script V2.0
# uses design in tree mac for matrix multiplication, available implementations: ['mm_bram_parallel']
...
EXPERIMENT_ROOT_DIR = 'experiments/gemmt_rp'
EXPERIMENT_ROOT_DIR_VTR = 'experiments-vtr/gemmt_rp'
WRAPPER_DIR = 'wrapper/mm_bram'
MODULE_DIR = 'gemmt_rp'
DEFAULT_WRAPPER_MODULE_NAME = 'mm_bram_wrapper'
...
DEFAULT_RESULT_DIR = 'results/gemmt_rp'
