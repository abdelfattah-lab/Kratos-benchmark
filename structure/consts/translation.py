...
TRANSLATIONS_GRAPH = {
    ...
    'concurrent_lut6s': 'Concurrent 6-LUTs',
    'adder': 'Adders',
    'adder_avg_util': 'Average Adder Utilisation',
    'lut5/adder': '5-LUT to Adder Ratio',
    'lut5_concurrency': '5-LUT Concurrency Percentage',
    'lut6/adder': '6-LUT to Adder Ratio',
    'lut6_concurrency': '6-LUT Concurrency Percentage',
    'lut56/adder': '5/6-LUT to Adder Ratio',
    'lut56_concurrency': '5/6-LUT Concurrency Percentage',
}