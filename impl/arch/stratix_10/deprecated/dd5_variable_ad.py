      ...
      <pb_type name="lab" num_pb="1">
            ...
            <pb_type name="ble5" num_pb="2">
              ...
              <mode name="arithmetic">
                <pb_type name="arithmetic" num_pb="1">
                  ...
                  <pb_type name="dual_lut4s" num_pb="1">
                    <!-- this can be used as a single 5-LUT or 2 4-LUTs sharing all 4 inputs.
                      Output pins will not be active at the same time. -->
                    <input name="in" num_pins="5"/>
                    ...
                    <mode name="as_dual_lut4s">
                      ...
                      <interconnect>
                        <direct name="lut4_in1" input="dual_lut4s.in[3:0]" output="lut4[0].in"/>
                        <direct name="lut4_in2" input="dual_lut4s.in[3:0]" output="lut4[1].in"/>
                        <direct name="lut4_outs" input="lut4.out" output="dual_lut4s.lut4_out"/>
                      </interconnect>
                    </mode>
                  </pb_type>
                  ...
                  <interconnect>
                    <direct name="ff_clock1" input="arithmetic.clk" output="ff[0].clk"/>
                    <direct name="ff_clock2" input="arithmetic.clk" output="ff[1].clk"/>
                    <direct name="lut4_in1" input="arithmetic.in" output="dual_lut4s.in"/>

                    <!-- add 2-1 mux from 4-LUTs to adder inputs. -->
                    <mux name="lut_to_add1" input="dual_lut4s.lut4_out[0] arithmetic.in_direct[0]" output="adder.a">
                      <delay_constant max="68.88e-12" in_port="dual_lut4s.lut4_out[0]" out_port="adder.a"/>
                      <delay_constant max="68.88e-12" in_port="arithmetic.in_direct[0]" out_port="adder.a"/>
                    </mux>
                    <mux name="lut_to_add2" input="dual_lut4s.lut4_out[1] arithmetic.in_direct[1]" output="adder.b">
                      <delay_constant max="68.88e-12" in_port="dual_lut4s.lut4_out[1]" out_port="adder.b"/>
                      <delay_constant max="68.88e-12" in_port="arithmetic.in_direct[1]" out_port="adder.b"/>
                    </mux>
                    
                    <direct name="add_to_ff" input="adder.sumout" output="ff[0].D">
                      <delay_constant max="15.58e-12" in_port="adder.sumout" out_port="ff[0].D"/>
                      <pack_pattern name="arith_ff" in_port="adder.sumout" out_port="ff[0].D"/>
                    </direct>
                    <direct name="lut5_to_ff" input="dual_lut4s.lut5_out" output="ff[1].D">
                      <pack_pattern name="lut5_ff" in_port="dual_lut4s.lut5_out" out_port="ff[1].D"/>
                    </direct>
                    ...
                    <complete name="sumout" input="ff[0].Q adder.sumout" output="arithmetic.out[0]">
                      <delay_constant max="61.34e-12" in_port="adder.sumout" out_port="arithmetic.out[0]"/>
                      <delay_constant max="43.49e-12" in_port="ff[0].Q" out_port="arithmetic.out[0]"/>
                    </complete>
                    <complete name="lut5_out" input="ff[1].Q dual_lut4s.lut5_out" output="arithmetic.out[1]">
                      <delay_constant max="43.49e-12" in_port="dual_lut4s.lut5_out" out_port="arithmetic.out[1]"/>
                      <delay_constant max="43.49e-12" in_port="ff[1].Q" out_port="arithmetic.out[1]"/>
                    </complete>
                  </interconnect>
                </pb_type>
                <interconnect>
                  <direct name="direct1" input="ble5.in" output="arithmetic.in"/>
                  <direct name="in_direct" input="ble5.in_direct" output="arithmetic.in_direct"/>
                ...
                <pb_type name="flut5" num_pb="1">
                  ...
                  <interconnect>
                    ...
                    <direct name="reg_in" input="flut5.in[0]" output="ff[0].D">
                      <delay_constant max="15.58e-12" in_port="flut5.in[0]" out_port="ff[0].D"/>
                    </direct>
                    ...
                    <complete name="out_mux" input="ff.Q lut5.out" output="flut5.out[1]">
                      <delay_constant max="43.49e-12" in_port="lut5.out" out_port="flut5.out[1]"/>
                      <delay_constant max="43.49e-12" in_port="ff.Q" out_port="flut5.out[1]"/>
                    </complete>
                  </interconnect>
                </pb_type>
                <interconnect>
        ...
        <interconnect>
          ...
          <complete name="lutA" input="lab.I4 lab.I3" output="fle[9:0].in[0:0]">
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I4" out_port="fle.in[0:0]"/>
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I3" out_port="fle.in[0:0]"/>
          </complete>
          <complete name="lutB" input="lab.I3 lab.I2" output="fle[9:0].in[1:1]">
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I3" out_port="fle.in[1:1]"/>
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I2" out_port="fle.in[1:1]"/>
          </complete>
          <complete name="lutC" input="lab.I2 lab.I1" output="fle[9:0].in[2:2]">
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I2" out_port="fle.in[2:2]"/>
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I1" out_port="fle.in[2:2]"/>
          </complete>
          <complete name="lutD" input="lab.I4 lab.I2" output="fle[9:0].in[3:3]">
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I4" out_port="fle.in[3:3]"/>
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I2" out_port="fle.in[3:3]"/>
          </complete>
          <complete name="lutE" input="lab.I3 lab.I1" output="fle[9:0].in[4:4]">
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I3" out_port="fle.in[4:4]"/>
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I1" out_port="fle.in[4:4]"/>
          </complete>
          <complete name="lutF" input="lab.I4 lab.I1" output="fle[9:0].in[5:5]">
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I4" out_port="fle.in[5:5]"/>
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I1" out_port="fle.in[5:5]"/>
          </complete>
          <complete name="lutG" input="lab.I4 lab.I3" output="fle[9:0].in[6:6]">
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I4" out_port="fle.in[6:6]"/>
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I3" out_port="fle.in[6:6]"/>
          </complete>
          <complete name="lutH" input="lab.I3 lab.I2" output="fle[9:0].in[7:7]">
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I3" out_port="fle.in[7:7]"/>
            <delay_constant max="{local_crossbar_delay_ps}e-12" in_port="lab.I2" out_port="fle.in[7:7]"/>
          </complete>
...
def get_local_crossbar_delay(ad_population: float):
    ...
    if ad_population not in local_crossbar_delays:
        raise ValueError(f"Unsupported AD crossbar population: {ad_population}")
    
    return local_crossbar_delays[ad_population]
...
def get_per_fle_area(ad_population: float):
    ...
    if ad_population not in per_fle_areas:
        raise ValueError(f"Unsupported AD crossbar population: {ad_population}")
    ...
    if population == 0.25:
        return """<!-- 25% sparsely populated local routing, direct adder connections from LAB-LAB pins only -->
          ...
          <complete name="directA_R" input="lab.I1[9:5] lab.I3[9:5]" output="fle[0:0].in_direct[3:0]">
            <delay_constant max="63.13e-12" in_port="lab.I1[9:5]" out_port="fle[0:0].in_direct[3:0]"/>
            <delay_constant max="63.13e-12" in_port="lab.I3[9:5]" out_port="fle[0:0].in_direct[3:0]"/>
          </complete>
          <complete name="directB_R" input="lab.I1[9:5] lab.I2[9:5]" output="fle[1:1].in_direct[3:0]">
            <delay_constant max="63.13e-12" in_port="lab.I1[9:5]" out_port="fle[1:1].in_direct[3:0]"/>
            <delay_constant max="63.13e-12" in_port="lab.I2[9:5]" out_port="fle[1:1].in_direct[3:0]"/>
          </complete>
          <complete name="directC_R" input="lab.I2[9:5] lab.I3[9:5]" output="fle[2:2].in_direct[3:0]">
            <delay_constant max="63.13e-12" in_port="lab.I2[9:5]" out_port="fle[2:2].in_direct[3:0]"/>
            <delay_constant max="63.13e-12" in_port="lab.I3[9:5]" out_port="fle[2:2].in_direct[3:0]"/>
          </complete>
          <complete name="directD_R" input="lab.I2[9:5] lab.I4[9:5]" output="fle[3:3].in_direct[3:0]">
            <delay_constant max="63.13e-12" in_port="lab.I2[9:5]" out_port="fle[3:3].in_direct[3:0]"/>
            <delay_constant max="63.13e-12" in_port="lab.I4[9:5]" out_port="fle[3:3].in_direct[3:0]"/>
          </complete>
          <complete name="directE_R" input="lab.I3[9:5] lab.I4[9:5]" output="fle[4:4].in_direct[3:0]">
            <delay_constant max="63.13e-12" in_port="lab.I3[9:5]" out_port="fle[4:4].in_direct[3:0]"/>
            <delay_constant max="63.13e-12" in_port="lab.I4[9:5]" out_port="fle[4:4].in_direct[3:0]"/>
          </complete>
          <!-- pins from left LAB -->
          <complete name="directA_L" input="lab.I1[14:10] lab.I3[14:10]" output="fle[5:5].in_direct[3:0]">
            <delay_constant max="63.13e-12" in_port="lab.I1[14:10]" out_port="fle[5:5].in_direct[3:0]"/>
            <delay_constant max="63.13e-12" in_port="lab.I3[14:10]" out_port="fle[5:5].in_direct[3:0]"/>
          </complete>
          <complete name="directB_L" input="lab.I1[14:10] lab.I2[14:10]" output="fle[6:6].in_direct[3:0]">
            <delay_constant max="63.13e-12" in_port="lab.I1[14:10]" out_port="fle[6:6].in_direct[3:0]"/>
            <delay_constant max="63.13e-12" in_port="lab.I2[14:10]" out_port="fle[6:6].in_direct[3:0]"/>
          </complete>
          <complete name="directC_L" input="lab.I2[14:10] lab.I3[14:10]" output="fle[7:7].in_direct[3:0]">
            <delay_constant max="63.13e-12" in_port="lab.I2[14:10]" out_port="fle[7:7].in_direct[3:0]"/>
            <delay_constant max="63.13e-12" in_port="lab.I3[14:10]" out_port="fle[7:7].in_direct[3:0]"/>
          </complete>
          <complete name="directD_L" input="lab.I2[14:10] lab.I4[14:10]" output="fle[8:8].in_direct[3:0]">
            <delay_constant max="63.13e-12" in_port="lab.I2[14:10]" out_port="fle[8:8].in_direct[3:0]"/>
            <delay_constant max="63.13e-12" in_port="lab.I4[14:10]" out_port="fle[8:8].in_direct[3:0]"/>
          </complete>
          <complete name="directE_L" input="lab.I3[14:10] lab.I4[14:10]" output="fle[9:9].in_direct[3:0]">
            <delay_constant max="63.13e-12" in_port="lab.I3[14:10]" out_port="fle[9:9].in_direct[3:0]"/>
            <delay_constant max="63.13e-12" in_port="lab.I4[14:10]" out_port="fle[9:9].in_direct[3:0]"/>
          </complete>
          <!-- end: direct LAB-LAB crossbar -->"""
    ...
    if population == 0.5:
        return """<!-- 50% sparsely populated local routing, direct adder connections from LAB-LAB pins only -->
          ...
          <complete name="directA_R" input="lab.I1[9:5] lab.I3[9:5] lab.I2[9:5] lab.I4[9:5]" output="fle[0:0].in_direct[3:0]">
            ...
            <delay_constant max="65.34e-12" in_port="lab.I3[9:5]" out_port="fle[0:0].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I2[9:5]" out_port="fle[0:0].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I4[9:5]" out_port="fle[0:0].in_direct[3:0]"/>
          </complete>
          <complete name="directB_R" input="lab.I1[9:5] lab.I3[9:5] lab.I2[9:5] lab.I4[9:5]" output="fle[1:1].in_direct[3:0]">
            <delay_constant max="65.34e-12" in_port="lab.I1[9:5]" out_port="fle[1:1].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I3[9:5]" out_port="fle[1:1].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I2[9:5]" out_port="fle[1:1].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I4[9:5]" out_port="fle[1:1].in_direct[3:0]"/>
          </complete>
          <complete name="directC_R" input="lab.I1[9:5] lab.I3[9:5] lab.I2[9:5] lab.I4[9:5]" output="fle[2:2].in_direct[3:0]">
            <delay_constant max="65.34e-12" in_port="lab.I1[9:5]" out_port="fle[2:2].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I3[9:5]" out_port="fle[2:2].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I2[9:5]" out_port="fle[2:2].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I4[9:5]" out_port="fle[2:2].in_direct[3:0]"/>
          </complete>
          <complete name="directD_R" input="lab.I1[9:5] lab.I3[9:5] lab.I2[9:5] lab.I4[9:5]" output="fle[3:3].in_direct[3:0]">
            <delay_constant max="65.34e-12" in_port="lab.I1[9:5]" out_port="fle[3:3].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I3[9:5]" out_port="fle[3:3].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I2[9:5]" out_port="fle[3:3].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I4[9:5]" out_port="fle[3:3].in_direct[3:0]"/>
          </complete>
          <complete name="directE_R" input="lab.I1[9:5] lab.I3[9:5] lab.I2[9:5] lab.I4[9:5]" output="fle[4:4].in_direct[3:0]">
            <delay_constant max="65.34e-12" in_port="lab.I1[9:5]" out_port="fle[4:4].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I3[9:5]" out_port="fle[4:4].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I2[9:5]" out_port="fle[4:4].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I4[9:5]" out_port="fle[4:4].in_direct[3:0]"/>
          </complete>
          <!-- pins from left LAB -->
          <complete name="directA_L" input="lab.I1[14:10] lab.I3[14:10] lab.I2[14:10] lab.I4[14:10]" output="fle[5:5].in_direct[3:0]">
            <delay_constant max="65.34e-12" in_port="lab.I1[14:10]" out_port="fle[5:5].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I3[14:10]" out_port="fle[5:5].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I2[14:10]" out_port="fle[5:5].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I4[14:10]" out_port="fle[5:5].in_direct[3:0]"/>
          </complete>
          <complete name="directB_L" input="lab.I1[14:10] lab.I3[14:10] lab.I2[14:10] lab.I4[14:10]" output="fle[6:6].in_direct[3:0]">
            <delay_constant max="65.34e-12" in_port="lab.I1[14:10]" out_port="fle[6:6].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I3[14:10]" out_port="fle[6:6].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I2[14:10]" out_port="fle[6:6].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I4[14:10]" out_port="fle[6:6].in_direct[3:0]"/>
          </complete>
          <complete name="directC_L" input="lab.I1[14:10] lab.I3[14:10] lab.I2[14:10] lab.I4[14:10]" output="fle[7:7].in_direct[3:0]">
            <delay_constant max="65.34e-12" in_port="lab.I1[14:10]" out_port="fle[7:7].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I3[14:10]" out_port="fle[7:7].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I2[14:10]" out_port="fle[7:7].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I4[14:10]" out_port="fle[7:7].in_direct[3:0]"/>
          </complete>
          <complete name="directD_L" input="lab.I1[14:10] lab.I3[14:10] lab.I2[14:10] lab.I4[14:10]" output="fle[8:8].in_direct[3:0]">
            <delay_constant max="65.34e-12" in_port="lab.I1[14:10]" out_port="fle[8:8].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I3[14:10]" out_port="fle[8:8].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I2[14:10]" out_port="fle[8:8].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I4[14:10]" out_port="fle[8:8].in_direct[3:0]"/>
          </complete>
          <complete name="directE_L" input="lab.I1[14:10] lab.I3[14:10] lab.I2[14:10] lab.I4[14:10]" output="fle[9:9].in_direct[3:0]">
            <delay_constant max="65.34e-12" in_port="lab.I1[14:10]" out_port="fle[9:9].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I3[14:10]" out_port="fle[9:9].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I2[14:10]" out_port="fle[9:9].in_direct[3:0]"/>
            <delay_constant max="65.34e-12" in_port="lab.I4[14:10]" out_port="fle[9:9].in_direct[3:0]"/>
          </complete>
          <!-- end: direct LAB-LAB crossbar -->"""
    ...
    if population == 0.75:
        return """<!-- 75% sparsely populated local routing, direct adder connections from LAB-LAB pins only -->
          ...
          <complete name="directA_R" input="lab.I1[14:5] lab.I3[14:5] lab.I2[9:5] lab.I4[9:5]" output="fle[0:0].in_direct[3:0]">
            ...
            <delay_constant max="69.33e-12" in_port="lab.I3[14:5]" out_port="fle[0:0].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I2[9:5]" out_port="fle[0:0].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I4[9:5]" out_port="fle[0:0].in_direct[3:0]"/>
          </complete>
          <complete name="directB_R" input="lab.I1[14:5] lab.I3[9:5] lab.I2[14:5] lab.I4[9:5]" output="fle[1:1].in_direct[3:0]">
            <delay_constant max="69.33e-12" in_port="lab.I1[14:5]" out_port="fle[1:1].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I3[9:5]" out_port="fle[1:1].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I2[14:5]" out_port="fle[1:1].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I4[9:5]" out_port="fle[1:1].in_direct[3:0]"/>
          </complete>
          <complete name="directC_R" input="lab.I1[9:5] lab.I3[14:5] lab.I2[14:5] lab.I4[9:5]" output="fle[2:2].in_direct[3:0]">
            <delay_constant max="69.33e-12" in_port="lab.I1[9:5]" out_port="fle[2:2].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I3[14:5]" out_port="fle[2:2].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I2[14:5]" out_port="fle[2:2].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I4[9:5]" out_port="fle[2:2].in_direct[3:0]"/>
          </complete>
          <complete name="directD_R" input="lab.I1[9:5] lab.I3[9:5] lab.I2[14:5] lab.I4[14:5]" output="fle[3:3].in_direct[3:0]">
            <delay_constant max="69.33e-12" in_port="lab.I1[9:5]" out_port="fle[3:3].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I3[9:5]" out_port="fle[3:3].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I2[14:5]" out_port="fle[3:3].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I4[14:5]" out_port="fle[3:3].in_direct[3:0]"/>
          </complete>
          <complete name="directE_R" input="lab.I1[9:5] lab.I3[14:5] lab.I2[9:5] lab.I4[14:5]" output="fle[4:4].in_direct[3:0]">
            <delay_constant max="69.33e-12" in_port="lab.I1[9:5]" out_port="fle[4:4].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I3[14:5]" out_port="fle[4:4].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I2[9:5]" out_port="fle[4:4].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I4[14:5]" out_port="fle[4:4].in_direct[3:0]"/>
          </complete>
          <!-- pins from left LAB -->
          <complete name="directA_L" input="lab.I1[14:5] lab.I3[14:5] lab.I2[9:5] lab.I4[9:5]" output="fle[5:5].in_direct[3:0]">
            <delay_constant max="69.33e-12" in_port="lab.I1[14:5]" out_port="fle[5:5].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I3[14:5]" out_port="fle[5:5].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I2[9:5]" out_port="fle[5:5].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I4[9:5]" out_port="fle[5:5].in_direct[3:0]"/>
          </complete>
          <complete name="directB_L" input="lab.I1[14:5] lab.I3[9:5] lab.I2[14:5] lab.I4[9:5]" output="fle[6:6].in_direct[3:0]">
            <delay_constant max="69.33e-12" in_port="lab.I1[14:5]" out_port="fle[6:6].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I3[9:5]" out_port="fle[6:6].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I2[14:5]" out_port="fle[6:6].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I4[9:5]" out_port="fle[6:6].in_direct[3:0]"/>
          </complete>
          <complete name="directC_L" input="lab.I1[9:5] lab.I3[14:5] lab.I2[14:5] lab.I4[9:5]" output="fle[7:7].in_direct[3:0]">
            <delay_constant max="69.33e-12" in_port="lab.I1[9:5]" out_port="fle[7:7].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I3[14:5]" out_port="fle[7:7].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I2[14:5]" out_port="fle[7:7].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I4[9:5]" out_port="fle[7:7].in_direct[3:0]"/>
          </complete>
          <complete name="directD_L" input="lab.I1[9:5] lab.I3[9:5] lab.I2[14:5] lab.I4[14:5]" output="fle[8:8].in_direct[3:0]">
            <delay_constant max="69.33e-12" in_port="lab.I1[9:5]" out_port="fle[8:8].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I3[9:5]" out_port="fle[8:8].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I2[14:5]" out_port="fle[8:8].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I4[14:5]" out_port="fle[8:8].in_direct[3:0]"/>
          </complete>
          <complete name="directE_L" input="lab.I1[9:5] lab.I3[14:5] lab.I2[9:5] lab.I4[14:5]" output="fle[9:9].in_direct[3:0]">
            <delay_constant max="69.33e-12" in_port="lab.I1[9:5]" out_port="fle[9:9].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I3[14:5]" out_port="fle[9:9].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I2[9:5]" out_port="fle[9:9].in_direct[3:0]"/>
            <delay_constant max="69.33e-12" in_port="lab.I4[14:5]" out_port="fle[9:9].in_direct[3:0]"/>
          </complete>
          <!-- end: direct LAB-LAB crossbar -->"""
    ...
    if population == 1.0:
        return """<!-- 100% populated local routing, direct adder connections from LAB-LAB pins only -->
          <complete name="directA" input="lab.I1[14:5] lab.I3[14:5] lab.I2[14:5] lab.I4[14:5]" output="fle[0:0].in_direct[3:0]">
            ...
            <delay_constant max="76.41e-12" in_port="lab.I2[14:5]" out_port="fle[0:0].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I4[14:5]" out_port="fle[0:0].in_direct[3:0]"/>
          </complete>
          <complete name="directB" input="lab.I1[14:5] lab.I3[14:5] lab.I2[14:5] lab.I4[14:5]" output="fle[1:1].in_direct[3:0]">
            <delay_constant max="76.41e-12" in_port="lab.I1[14:5]" out_port="fle[1:1].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I3[14:5]" out_port="fle[1:1].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I2[14:5]" out_port="fle[1:1].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I4[14:5]" out_port="fle[1:1].in_direct[3:0]"/>
          </complete>
          <complete name="directC" input="lab.I1[14:5] lab.I3[14:5] lab.I2[14:5] lab.I4[14:5]" output="fle[2:2].in_direct[3:0]">
            <delay_constant max="76.41e-12" in_port="lab.I1[14:5]" out_port="fle[2:2].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I3[14:5]" out_port="fle[2:2].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I2[14:5]" out_port="fle[2:2].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I4[14:5]" out_port="fle[2:2].in_direct[3:0]"/>
          </complete>
          <complete name="directD" input="lab.I1[14:5] lab.I3[14:5] lab.I2[14:5] lab.I4[14:5]" output="fle[3:3].in_direct[3:0]">
            <delay_constant max="76.41e-12" in_port="lab.I1[14:5]" out_port="fle[3:3].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I3[14:5]" out_port="fle[3:3].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I2[14:5]" out_port="fle[3:3].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I4[14:5]" out_port="fle[3:3].in_direct[3:0]"/>
          </complete>
          <complete name="directE" input="lab.I1[14:5] lab.I3[14:5] lab.I2[14:5] lab.I4[14:5]" output="fle[4:4].in_direct[3:0]">
            <delay_constant max="76.41e-12" in_port="lab.I1[14:5]" out_port="fle[4:4].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I3[14:5]" out_port="fle[4:4].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I2[14:5]" out_port="fle[4:4].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I4[14:5]" out_port="fle[4:4].in_direct[3:0]"/>
          </complete>
          <complete name="directF" input="lab.I1[14:5] lab.I3[14:5] lab.I2[14:5] lab.I4[14:5]" output="fle[5:5].in_direct[3:0]">
            <delay_constant max="76.41e-12" in_port="lab.I1[14:5]" out_port="fle[5:5].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I3[14:5]" out_port="fle[5:5].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I2[14:5]" out_port="fle[5:5].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I4[14:5]" out_port="fle[5:5].in_direct[3:0]"/>
          </complete>
          <complete name="directG" input="lab.I1[14:5] lab.I3[14:5] lab.I2[14:5] lab.I4[14:5]" output="fle[6:6].in_direct[3:0]">
            <delay_constant max="76.41e-12" in_port="lab.I1[14:5]" out_port="fle[6:6].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I3[14:5]" out_port="fle[6:6].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I2[14:5]" out_port="fle[6:6].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I4[14:5]" out_port="fle[6:6].in_direct[3:0]"/>
          </complete>
          <complete name="directH" input="lab.I1[14:5] lab.I3[14:5] lab.I2[14:5] lab.I4[14:5]" output="fle[7:7].in_direct[3:0]">
            <delay_constant max="76.41e-12" in_port="lab.I1[14:5]" out_port="fle[7:7].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I3[14:5]" out_port="fle[7:7].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I2[14:5]" out_port="fle[7:7].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I4[14:5]" out_port="fle[7:7].in_direct[3:0]"/>
          </complete>
          <complete name="directI" input="lab.I1[14:5] lab.I3[14:5] lab.I2[14:5] lab.I4[14:5]" output="fle[8:8].in_direct[3:0]">
            <delay_constant max="76.41e-12" in_port="lab.I1[14:5]" out_port="fle[8:8].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I3[14:5]" out_port="fle[8:8].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I2[14:5]" out_port="fle[8:8].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I4[14:5]" out_port="fle[8:8].in_direct[3:0]"/>
          </complete>
          <complete name="directJ" input="lab.I1[14:5] lab.I3[14:5] lab.I2[14:5] lab.I4[14:5]" output="fle[9:9].in_direct[3:0]">
            <delay_constant max="76.41e-12" in_port="lab.I1[14:5]" out_port="fle[9:9].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I3[14:5]" out_port="fle[9:9].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I2[14:5]" out_port="fle[9:9].in_direct[3:0]"/>
            <delay_constant max="76.41e-12" in_port="lab.I4[14:5]" out_port="fle[9:9].in_direct[3:0]"/>
          </complete>
          <!-- end: direct LAB-LAB crossbar -->"""
...
DEFAULTS = {
    ...
    'ad_crossbar_population': 0.25, # population of AD crossbar w.r.t. 40 sneak paths
}

class DD5ADArchFactory(ArchFactory, ParamsChecker):
    def get_name(self, cin_mux_stride: int, enable_lut6: bool, fixed_size: tuple[int, int]|None, ad_crossbar_population: float, **kwargs):
        name = f"type.dd5_cin.{cin_mux_stride}_ad.{ad_crossbar_population}"
        if not enable_lut6:
            name += "_l6.off"
    ...
    def verify_params(self, params):
        params = self.verify_required_keys(DEFAULTS, [], params)
        params['per_fle_area'] = get_per_fle_area(params['ad_crossbar_population'])

        return params
    
    def get_arch(self, cin_mux_stride: int, enable_lut6: bool, per_fle_area: float, fixed_size: tuple[int, int]|None, ad_crossbar_population: float, **kwargs):
        ...
        return TEMPLATE.format(
            ...
            local_crossbar_delay_ps=get_local_crossbar_delay(ad_crossbar_population),
            ad_crossbar_wiring=gen_ad_crossbar_wiring(ad_crossbar_population),
        )
