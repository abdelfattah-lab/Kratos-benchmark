...
<architecture>
  ...
  <layout>
    ...
    {layout_sizing_start}
      ...
      <!--Column
      of 'mult_27' with 'EMPTY' blocks wherever a 'mult_27' does not fit. Vertical offset by 1 for
      perimeter.-->
      <col type="mult_27" startx="6" starty="1" repeatx="8" priority="20" />
      <col type="EMPTY" startx="6" repeatx="8" starty="1" priority="19" />
      <!--Column
      of 'memory' with 'EMPTY' blocks wherever a 'memory' does not fit. Vertical offset by 1 for
      perimeter.-->
  ...
  <switchlist>
    <switch type="mux" name="0" R="0.0" Cin="0.0" Cout="0.0" Tdel="230.9e-12" mux_trans_size="2.173"
      buf_size="36.6" />
    <switch type="mux" name="ipin_cblock" R="0.0" Cout="0.0" Cin="0.0" Tdel="145e-12"
      mux_trans_size="1.508" buf_size="11.525" />
  </switchlist>
  <segmentlist>
  ...
  <directlist>
    <direct name="adder_carry" from_pin="clb.cout" to_pin="clb.cin" x_offset="0" y_offset="-1"
      z_offset="0" />
    <!-- Direct connect to left and right LAB -->
    <direct name="direct_right_1" from_pin="clb.O[4:0]" to_pin="clb.I1[9:5]" x_offset="1"
      y_offset="0" z_offset="0" />
    <direct name="direct_right_2" from_pin="clb.O[24:20]" to_pin="clb.I2[9:5]" x_offset="1"
      y_offset="0" z_offset="0" />
    <direct name="direct_right_3" from_pin="clb.O[9:5]" to_pin="clb.I3[9:5]" x_offset="1"
      y_offset="0" z_offset="0" />
    <direct name="direct_right_4" from_pin="clb.O[29:25]" to_pin="clb.I4[9:5]" x_offset="1"
      y_offset="0" z_offset="0" />
    <direct name="direct_left_1" from_pin="clb.O[14:10]" to_pin="clb.I1[14:10]" x_offset="-1"
      y_offset="0" z_offset="0" />
    <direct name="direct_left_2" from_pin="clb.O[34:30]" to_pin="clb.I2[14:10]" x_offset="-1"
      y_offset="0" z_offset="0" />
    <direct name="direct_left_3" from_pin="clb.O[19:15]" to_pin="clb.I3[14:10]" x_offset="-1"
      y_offset="0" z_offset="0" />
    <direct name="direct_left_4" from_pin="clb.O[39:35]" to_pin="clb.I4[14:10]" x_offset="-1"
      y_offset="0" z_offset="0" />
  </directlist>
  <complexblocklist>
    <!-- Define I/O pads begin -->
    <!-- Capacity is a unique property of I/Os, it is the maximum number of I/Os that can be placed
    at the same (X,Y) location on the FPGA -->
    <!-- Not sure of the area of an I/O (varies widely), and it's not relevant to the design of the
    FPGA core, so we're setting it to 0. -->
    <pb_type name="io">
      <input name="outpad" num_pins="1" />
      <output name="inpad" num_pins="1" />
      <clock name="clock" num_pins="1" />
      ...
      <!-- IOs go on the periphery of the FPGA, for consistency, 
          ...
          If I do not make a physically equivalent definition, then I need to define 4 different I/Os, one
      for each side of the FPGA
        -->
    ...
    <pb_type name="clb">
      ...
      <pb_type name="lab" num_pb="1">
        ...
        <!-- Describe fracturable logic element.  
                 Each fracturable logic element has a 6-LUT that can alternatively operate as two 5-LUTs with shared
        inputs. 
              ...
              <mode name="blut5">
                <pb_type name="flut5" num_pb="1">
                  ...
                  <pb_type name="lut5" blif_model=".names" num_pb="1" class="lut">
                    ...
                    <!-- These are the physical delay inputs on a Stratix 10 LUT but because VPR
                    cannot do LUT rebalancing,
                             we instead take the average of these numbers to get more stable results
                             note that those are the same delays for inputs A - E as the ones used for the 6-LUT, however, we
                    have 
                ...
                <pb_type name="arithmetic" num_pb="1">
                  ...
                  <interconnect>
                    ...
                    <direct name="add_to_ff" input="adder.sumout" output="ff.D">
                      ...
                      <!--pack_pattern
                      name="chain" in_port="adder.sumout" out_port="ff.D"/-->
                    </direct>
                    ...
                    <complete name="sumout" input="ff.Q adder.sumout" output="arithmetic.out">
                      <delay_constant max="39.85e-12" in_port="adder.sumout"
                        out_port="arithmetic.out" />
        ...
        <interconnect>
          ...
          <!-- This way of specifying direct connection to clb outputs is important because this
          architecture uses automatic spreading of opins.  
                     By grouping to output pins in this fashion, if a logic block is completely filled by 6-LUTs, 
                     then the outputs those 6-LUTs take get evenly distributed across all four sides of the CLB instead
          of clumped on two sides (which is what happens with a more
                     naive specification).
              -->
      ...
      <mode name="two_mult_18x19">
        ...
        <interconnect>
          <direct name="datain2a1" input="mult_27.datain[17:0]" output="two_mult_18x19[0].a">
            <delay_constant max="134e-12" in_port="mult_27.datain[17:0]"
              out_port="two_mult_18x19[0].a" />
          </direct>
          <direct name="datain2b1" input="mult_27.datain[36:18]" output="two_mult_18x19[0].b">
            <delay_constant max="134e-12" in_port="mult_27.datain[36:18]"
              out_port="two_mult_18x19[0].b" />
          </direct>
          <direct name="datain2a2" input="mult_27.datain[54:37]" output="two_mult_18x19[1].a">
            <delay_constant max="134e-12" in_port="mult_27.datain[54:37]"
              out_port="two_mult_18x19[1].a" />
          </direct>
          <direct name="datain2b2" input="mult_27.datain[73:55]" output="two_mult_18x19[1].b">
            <delay_constant max="134e-12" in_port="mult_27.datain[73:55]"
              out_port="two_mult_18x19[1].b" />
          </direct>
          <direct name="out2dataout" input="two_mult_18x19[1:0].out" output="mult_27.dataout">
            <delay_constant max="1.09e-9" in_port="two_mult_18x19[1:0].out"
              out_port="mult_27.dataout" />
          </direct>
        </interconnect>
      </mode>
      <mode name="mult_27x27">
        ...
        <interconnect>
          ...
          <direct name="datain2b" input="mult_27.datain[53:27]" output="one_mult_27x27.b">
            <delay_constant max="134e-12" in_port="mult_27.datain[53:27]"
              out_port="one_mult_27x27.b" />
          </direct>
          <direct name="out2dataout" input="one_mult_27x27.out" output="mult_27.dataout[53:0]">
            <delay_constant max="1.93e-9" in_port="one_mult_27x27.out"
              out_port="mult_27.dataout[53:0]" />
          </direct>
        </interconnect>
      </mode>
    ...
    <pb_type name="memory">
      ...
      <mode name="mem_1024x20_sp">
        <pb_type name="mem_1024x20_sp" blif_model=".subckt single_port_ram" class="memory"
          num_pb="1">
      ...
      <mode name="mem_2048x10_sp">
        <pb_type name="mem_2048x10_sp" blif_model=".subckt single_port_ram" class="memory"
          num_pb="1">
        ...
        <interconnect>
          <direct name="address1" input="memory.addr1[10:0]" output="mem_2048x10_sp.addr">
            <delay_constant max="132e-12" in_port="memory.addr1[10:0]"
              out_port="mem_2048x10_sp.addr" />
          </direct>
      ...
      <mode name="mem_1024x20_dp">
        ...
        <interconnect>
          <direct name="address1" input="memory.addr1[9:0]" output="mem_1024x20_dp.addr1">
            <delay_constant max="132e-12" in_port="memory.addr1[9:0]"
              out_port="mem_1024x20_dp.addr1" />
          </direct>
          <direct name="address2" input="memory.addr2[9:0]" output="mem_1024x20_dp.addr2">
            <delay_constant max="132e-12" in_port="memory.addr2[9:0]"
              out_port="mem_1024x20_dp.addr2" />
          </direct>
          <direct name="data1" input="memory.data[19:0]" output="mem_1024x20_dp.data1">
            <delay_constant max="132e-12" in_port="memory.data[19:0]"
              out_port="mem_1024x20_dp.data1" />
          </direct>
          <direct name="data2" input="memory.data[39:20]" output="mem_1024x20_dp.data2">
            <delay_constant max="132e-12" in_port="memory.data[39:20]"
              out_port="mem_1024x20_dp.data2" />
          </direct>
      ...
      <mode name="mem_2048x10_dp">
        ...
        <interconnect>
          <direct name="address1" input="memory.addr1[10:0]" output="mem_2048x10_dp.addr1">
            <delay_constant max="132e-12" in_port="memory.addr1[10:0]"
              out_port="mem_2048x10_dp.addr1" />
          </direct>
          <direct name="address2" input="memory.addr2[10:0]" output="mem_2048x10_dp.addr2">
            <delay_constant max="132e-12" in_port="memory.addr2[10:0]"
              out_port="mem_2048x10_dp.addr2" />
          </direct>
          ...
          <direct name="data2" input="memory.data[19:10]" output="mem_2048x10_dp.data2">
            <delay_constant max="132e-12" in_port="memory.data[19:10]"
              out_port="mem_2048x10_dp.data2" />
          </direct>
    ...
    return """<mode name="n1_lut6">
            <pb_type name="ble6" num_pb="1">
              ...
              <pb_type name="lut6" blif_model=".names" num_pb="1" class="lut">
                ...
                <output name="out" num_pins="1" port_class="lut_out" />
                <!-- LUT timing using delay matrix -->
                <!-- These are the physical delay inputs on a Stratix 10 LUT but because VPR cannot
                do LUT rebalancing,
                           we instead take the average of these numbers to get more stable results
                           257.8e-12
                           253.69e-12
...
class OriginalBaseArchFactory(ArchFactory, ParamsChecker):
    def get_name(self, enable_lut6: bool, fixed_size: tuple[int, int]|None, **kwargs):
        name = "type.s10-base-original"
        if not enable_lut6:
            name += "_l6.off"
