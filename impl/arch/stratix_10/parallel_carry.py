...
<direct name="couts" input="fle[{ble_count-1}:{ble_count-1}].cout" output="lab.cout">
    <pack_pattern name="chain" in_port="fle[{ble_count-1}:{ble_count-1}].cout" out_port="lab.cout"/>
</direct>
"""   
...
class ParallelCarryArchFactory(ArchFactory, ParamsChecker):
    def get_name(self, **kwargs):
        return f"type.s10-cin"
