...
- All sneak paths only go to right LAB (instead of 50-50 split)
"""
...
<architecture>
  ...
  <directlist>
    ...
    <!-- Direct connect to right LAB only -->
    <direct name="direct_right_1" from_pin="clb.O_direct[9:0]" to_pin="clb.I1[14:5]" x_offset="1" y_offset="0" z_offset="0"/>
    <direct name="direct_right_2" from_pin="clb.O_direct[29:20]" to_pin="clb.I2[14:5]" x_offset="1" y_offset="0" z_offset="0"/>
    <direct name="direct_right_3" from_pin="clb.O_direct[19:10]" to_pin="clb.I3[14:5]" x_offset="1" y_offset="0" z_offset="0"/>
    <direct name="direct_right_4" from_pin="clb.O_direct[39:30]" to_pin="clb.I4[14:5]" x_offset="1" y_offset="0" z_offset="0"/>
  </directlist>
  <complexblocklist>
    ...
    <pb_type name="clb">
      ...
      <pb_type name="lab" num_pb="1">
        ...
        <interconnect>
          ...
          <!-- pins from left LAB -->
          <complete name="directA_R" input="lab.I1[14:5]" output="fle[0:0].in_direct[3:0]">
            <delay_constant max="76.33e-12" in_port="lab.I1[14:5]" out_port="fle[0:0].in_direct[3:0]"/>
          </complete>
          <complete name="directB_R" input="lab.I1[14:7] lab.I3[6:5]" output="fle[1:1].in_direct[3:0]">
            <delay_constant max="76.33e-12" in_port="lab.I1[14:7]" out_port="fle[1:1].in_direct[3:0]"/>
            <delay_constant max="76.33e-12" in_port="lab.I3[6:5]" out_port="fle[1:1].in_direct[3:0]"/>
          </complete>
          <complete name="directC_R" input="lab.I1[14:8] lab.I3[7:5]" output="fle[2:2].in_direct[3:0]">
            <delay_constant max="76.33e-12" in_port="lab.I1[14:8]" out_port="fle[2:2].in_direct[3:0]"/>
            <delay_constant max="76.33e-12" in_port="lab.I3[7:5]" out_port="fle[2:2].in_direct[3:0]"/>
          </complete>
          <complete name="directD_R" input="lab.I3[14:5]" output="fle[3:3].in_direct[3:0]">
            <delay_constant max="76.33e-12" in_port="lab.I3[14:5]" out_port="fle[3:3].in_direct[3:0]"/>
          </complete>
          <complete name="directE_R" input="lab.I3[14:8] lab.I2[7:5]" output="fle[4:4].in_direct[3:0]">
            <delay_constant max="76.33e-12" in_port="lab.I3[14:8]" out_port="fle[4:4].in_direct[3:0]"/>
            <delay_constant max="76.33e-12" in_port="lab.I2[7:5]" out_port="fle[4:4].in_direct[3:0]"/>
          </complete>
          <complete name="directF_R" input="lab.I3[14:12] lab.I2[11:5]" output="fle[5:5].in_direct[3:0]">
            <delay_constant max="76.33e-12" in_port="lab.I3[14:12]" out_port="fle[5:5].in_direct[3:0]"/>
            <delay_constant max="76.33e-12" in_port="lab.I2[11:5]" out_port="fle[5:5].in_direct[3:0]"/>
          </complete>
          <complete name="directG_R" input="lab.I2[14:5]" output="fle[6:6].in_direct[3:0]">
            <delay_constant max="76.33e-12" in_port="lab.I2[14:5]" out_port="fle[6:6].in_direct[3:0]"/>
          </complete>
          <complete name="directH_R" input="lab.I2[14:12] lab.I4[11:5]" output="fle[7:7].in_direct[3:0]">
            <delay_constant max="76.33e-12" in_port="lab.I2[14:12]" out_port="fle[7:7].in_direct[3:0]"/>
            <delay_constant max="76.33e-12" in_port="lab.I4[11:5]" out_port="fle[7:7].in_direct[3:0]"/>
          </complete>
          <complete name="directI_R" input="lab.I2[14:13] lab.I4[12:5]" output="fle[8:8].in_direct[3:0]">
            <delay_constant max="76.33e-12" in_port="lab.I2[14:13]" out_port="fle[8:8].in_direct[3:0]"/>
            <delay_constant max="76.33e-12" in_port="lab.I4[12:5]" out_port="fle[8:8].in_direct[3:0]"/>
          </complete>
          <complete name="directJ_R" input="lab.I4[14:5]" output="fle[9:9].in_direct[3:0]">
            <delay_constant max="76.33e-12" in_port="lab.I4[14:5]" out_port="fle[9:9].in_direct[3:0]"/>
          </complete>
