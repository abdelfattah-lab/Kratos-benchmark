    ...
    <pb_type name="clb">
      ...
      <pb_type name="lab" num_pb="1">
        ...
        <pb_type name="fle" num_pb="10">
                ...
                <pb_type name="arithmetic" num_pb="1">
                  ...
                  <interconnect>
                    ...
                    <complete name="sumout" input="ff[0].Q adder.sumout" output="arithmetic.out">
                      <delay_constant max="59.07e-12" in_port="adder.sumout" out_port="arithmetic.out"/>
              ...
              <mode name="blut5">
                <pb_type name="flut5" num_pb="1">
                  ...
                  <interconnect>
                    ...
                    <complete name="out_mux" input="flut5.in[0] ff.Q lut5.out" output="flut5.out">
                      <delay_constant max="59.07e-12" in_port="flut5.in[0]" out_port="flut5.out"/>
                      <delay_constant max="53.74e-12" in_port="lut5.out" out_port="flut5.out"/>
                      <delay_constant max="45.95e-12" in_port="ff.Q" out_port="flut5.out"/>
                    </complete>
                  </interconnect>
                </pb_type>
                <interconnect>
          ...
          <mode name="n1_lut6_arith">
            <pb_type name="ble6_arith" num_pb="1">
              ...
              <pb_type name="ff" blif_model=".latch" num_pb="3" class="flipflop">
                <input name="D" num_pins="1" port_class="D"/>
                <output name="Q" num_pins="1" port_class="Q"/>
                <clock name="clk" num_pins="1" port_class="clock"/>
                <T_setup value="18.91e-12" port="ff.D" clock="clk"/>
              ...
              <interconnect>
                <complete name="clock" input="ble6_arith.clk" output="ff.clk"/>
                
                <direct name="lut6_inputs" input="ble6_arith.in" output="lut6.in"/>
                
                <direct name="carry_in" input="ble6_arith.cin" output="adder[0].cin">
                  <pack_pattern name="chain_arith" in_port="ble6_arith.cin" out_port="adder[0].cin"/>
                </direct>
                ...
                <direct name="carry_out" input="adder[1].cout" output="ble6_arith.cout">
                  <pack_pattern name="chain_arith" in_port="adder[1].cout" out_port="ble6_arith.cout"/>
                </direct>

                <direct name="adder_in1" input="ble6_arith.in_direct[0]" output="adder[0].a">
                  <delay_constant max="68.88e-12" in_port="ble6_arith.in_direct[0]" out_port="adder[0].a"/>
                </direct>
                <direct name="adder_in2" input="ble6_arith.in_direct[1]" output="adder[0].b">
                  <delay_constant max="68.88e-12" in_port="ble6_arith.in_direct[1]" out_port="adder[0].b"/>
                </direct>
                <direct name="adder_in3" input="ble6_arith.in_direct[2]" output="adder[1].a">
                  <delay_constant max="68.88e-12" in_port="ble6_arith.in_direct[2]" out_port="adder[1].a"/>
                </direct>
                <direct name="adder_in4" input="ble6_arith.in_direct[3]" output="adder[1].b">
                  <delay_constant max="68.88e-12" in_port="ble6_arith.in_direct[3]" out_port="adder[1].b"/>
                </direct>
                
                <direct name="adder_ff1" input="adder[0].sumout" output="ff[0].D">
                  <delay_constant max="15.58e-12" in_port="adder[0].sumout" out_port="ff[0].D"/>
                  <!--<pack_pattern name="adder1_ff" in_port="adder[0].sumout" out_port="ff[0].D"/>-->
                </direct>
                <direct name="adder_ff2" input="adder[1].sumout" output="ff[1].D">
                  <delay_constant max="15.58e-12" in_port="adder[1].sumout" out_port="ff[1].D"/>
                  <!--<pack_pattern name="adder2_ff" in_port="adder[1].sumout" out_port="ff[1].D"/>-->
                </direct>

                <direct name="lut6_ff" input="lut6.out" output="ff[2].D">
                  <delay_constant max="15.58e-12" in_port="lut6.out" out_port="ff[2].D"/>
                  <pack_pattern name="ble6_arith" in_port="lut6.out" out_port="ff[2].D"/>
                </direct>

                <mux name="O1" input="adder[0].sumout ff[0].Q" output="ble6_arith.out[0]">
                  <delay_constant max="59.07e-12" in_port="adder[0].sumout" out_port="ble6_arith.out[0]"/>
                  <delay_constant max="43.49e-12" in_port="ff[0].Q" out_port="ble6_arith.out[0]"/>
                </mux>
                <direct name="O2" input="lut6.out" output="ble6_arith.out[1]">
                  <delay_constant max="48.41e-12" in_port="lut6.out" out_port="ble6_arith.out[1]"/>
                </direct>
                <mux name="O3" input="adder[1].sumout ff[1].Q" output="ble6_arith.out[2]">
                  <delay_constant max="59.07e-12" in_port="adder[1].sumout" out_port="ble6_arith.out[2]"/>
                  <delay_constant max="43.49e-12" in_port="ff[1].Q" out_port="ble6_arith.out[2]"/>
                </mux>
                <mux name="O4" input="lut6.out ff[2].Q" output="ble6_arith.out[3]">
                  <delay_constant max="59.07e-12" in_port="lut6.out" out_port="ble6_arith.out[3]"/>
                  <delay_constant max="43.49e-12" in_port="ff[2].Q" out_port="ble6_arith.out[3]"/>
                </mux>
              </interconnect>
            </pb_type>
            <interconnect>
              <!-- ble6_arith takes inputs A, B, C, D, E, & F; where F is fle[7] -->
              <direct name="lut6_inputs1" input="fle.in[4:0]" output="ble6_arith.in[4:0]"/>
              <direct name="lut6_inputs2" input="fle.in[7]" output="ble6_arith.in[5]"/>
              <direct name="lut6_in_direct" input="fle.in_direct" output="ble6_arith.in_direct"/>
              <direct name="direct2" input="ble6_arith.out" output="fle.out"/>
              <direct name="direct4" input="fle.clk" output="ble6_arith.clk"/>

              <direct name="carry_in" input="fle.cin" output="ble6_arith.cin">
                <!--<pack_pattern name="chain_arith6" in_port="fle.cin" out_port="ble6_arith.cin"/>-->
              </direct>
              <direct name="carry_out" input="ble6_arith.cout" output="fle.cout">
                <!--<pack_pattern name="chain_arith6" in_port="ble6_arith.cout" out_port="fle.cout"/>-->
              </direct>
            </interconnect>
          </mode>
          <!-- n1_lut6_arith -->
          ...
          <mode name="n1_lut6">
            <pb_type name="ble6" num_pb="1">
              ...
              <interconnect>
                ...
                <direct name="direct_ff1" input="ble6.in[0]" output="ff[0].D">
                  <delay_constant max="15.58e-12" in_port="ble6.in[0]" out_port="ff[0].D"/>
                </direct>
                <direct name="direct_ff2" input="ble6.in[1]" output="ff[1].D">
                  <delay_constant max="15.58e-12" in_port="ble6.in[1]" out_port="ff[1].D"/>
                </direct>

                <direct name="lut6_ff" input="lut6.out" output="ff[2].D">
                  <delay_constant max="15.58e-12" in_port="lut6.out" out_port="ff[2].D"/>
                  <pack_pattern name="ble6_ff" in_port="lut6.out" out_port="ff[2].D"/>
                </direct>

                <mux name="O1" input="ble6.in[0] ff[0].Q" output="ble6.out[0]">
                  <delay_constant max="59.07e-12" in_port="ble6.in[0]" out_port="ble6.out[0]"/>
                  <delay_constant max="43.49e-12" in_port="ff[0].Q" out_port="ble6.out[0]"/>
                </mux>
                <direct name="O2" input="lut6.out" output="ble6.out[1]">
                  <delay_constant max="48.41e-12" in_port="lut6.out" out_port="ble6.out[1]"/>
                </direct>
                <mux name="O3" input="ble6.in[1] ff[1].Q" output="ble6.out[2]">
                  <delay_constant max="59.07e-12" in_port="ble6.in[1]" out_port="ble6.out[2]"/>
                  <delay_constant max="43.49e-12" in_port="ff[1].Q" out_port="ble6.out[2]"/>
                </mux>
                <mux name="O4" input="lut6.out ff[2].Q" output="ble6.out[3]">
                  <delay_constant max="59.07e-12" in_port="lut6.out" out_port="ble6.out[3]"/>
                  <delay_constant max="43.49e-12" in_port="ff[2].Q" out_port="ble6.out[3]"/>
                </mux>
              </interconnect>
            </pb_type>
            <interconnect>
...
class LUTSkip6ArchFactory(ArchFactory, ParamsChecker):
    def get_name(self, cin_mux_stride: int, fixed_size: tuple[int, int]|None, **kwargs):
        name = f"type.s10-skip-6alt_cin.{cin_mux_stride}"
    ...
    def get_netstats(self, root: Element) -> dict[str, any]:
        ...
        concurrent_lut6s = 0
        for ble6_block in ns.find_all_block_instances(root, 'ble6_arith[0]'):
            adder_block0 = ns.get_valid_child_block_instance(ble6_block, 'adder[0]')
            adder_block1 = ns.get_valid_child_block_instance(ble6_block, 'adder[1]')
            lut6_block = ns.get_valid_child_block_instance(ble6_block, 'lut6[0]')
            if (adder_block0 is not None or adder_block1 is not None) and (lut6_block is not None):
                concurrent_lut6s += 1
